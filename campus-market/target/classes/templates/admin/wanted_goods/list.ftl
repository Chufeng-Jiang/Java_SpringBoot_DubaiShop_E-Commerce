...
<title>${siteName!""}|Wanted Goods-${title!""}</title>
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if sn??>Student No.<#elseif name??>Name<#else>Search criteria</#if> <span class="caret"></span>
                      </button>
                    ...
                    <input type="text" class="form-control" value="${name!sn!""}" id="search-value" name="<#if sn??>student.sn<#else>name</#if>" placeholder="Please input the goods you are looking for">
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>Name of wanted goods</th>
                        <th>Publisher</th>
                        <th>Expected Price</th>
                        <th>Expected Trading Location</th>
                        <th>Time Stamp</th>
                      </tr>
                    </thead>
                    <tbody>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('Delete wanted items successful.',function(){
