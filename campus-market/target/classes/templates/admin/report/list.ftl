...
<title>${siteName!""}|Item Reporting-${title!""}</title>
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      <button class="btn btn-default dropdown-toggle" id="search-btn" data-toggle="dropdown" type="button" aria-haspopup="true" aria-expanded="false">
                      	<#if name??>Goods Name<#elseif sn??>Student No.<#elseif content??>Reasons<#else>Search criteria</#if> <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="content">Reasons</a> </li>
                    ...
                    <input type="text" class="form-control" value="${content!sn!name!""}" id="search-value" name="<#if name??>goods.name<#elseif sn??>student.sn<#else>content</#if>" placeholder="Please input the goods you want">
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th>Goods Picture</th>
                        <th>Goods Name</th>
                        <th>Whistle-blower(Student Number)</th>
                        <th style="width:256px;">Reasons</th>
                        <th>Time Stamp</th>
                      </tr>
                    </thead>
                    <tbody>
                    ...
                    <#else>
                    <tr align="center"><td colspan="6">There is empty.</td></tr>
					</#if>
                    </tbody>
                  </table>
                </div>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('Reported item deleted successfully!',function(){
