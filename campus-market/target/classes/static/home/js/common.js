...
function register(){//注册
    ...
    $(".load-tip").text('Registration in process');
    ...
    $.post(
        ...
        function(res) {
            ...
            if (res.code == 0) {
                ...
                var school_area='<div id="department-container" class="hidden"><div id="department-wrapper"><div class="sel-head"><h2>Please Select Your University</h2></div>'+
                    '<div id="sel-d2" class="sel-d2 hidden"><div class="sel-school"><div class="sel-hd"><h3>University</h3><input type="text" value="" class="department-item" disabled="true">'+
                    '<a href="javascript:;"><img src="http://www.2shoujie.com/resource/image/arr-right.png"></a></div>'+
                    '<div class="sel-content"><div class="school-search"><input placeholder="Please Select Your University" type="text" value="" class=""><ul class="search-down hidden"></ul></div>'+
                    '<ul class="sel-items"></ul></div></div><div class="sel-academy"><div class="sel-hd"><h3>Department</h3><input type="text" value="" class="department-item" disabled="true">'+
                    '<a href="javascript:;"><img src="http://www.2shoujie.com/resource/image/arr-right.png"></a></div><div class="sel-content">'+
                    '<ul class="sel-items"></ul></div></div><div class="sel-adyear"><div class="sel-hd"><h3>Enrollment time</h3><input type="text" value="" class="department-item" disabled="true">'+
...
function off_shelf(pid){
    if (!confirm('Please confirm whether to put the item off shelf.')) {
        return;
    }
    $.post('productedit', 
    		{"pid" : pid,"flag":1},
...
function sold(goods_id){
    ...
    if (!confirm('Please confirm the items has been sold.')) {
    	alert("Cancel");
        return;
    }
