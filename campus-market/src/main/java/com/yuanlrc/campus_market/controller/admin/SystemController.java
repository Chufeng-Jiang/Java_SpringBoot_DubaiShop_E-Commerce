...
public class SystemController {
	...
	public Result<Boolean> login(HttpServletRequest request,User user,String cpacha){
		...
		//将登陆记录写入日志库
		operaterLogService.add("User [ "+user.getUsername()+" ] log in at [" + StringUtil.getFormatterDate(new Date(), "yyyy-MM-dd HH:mm:ss") + "]");
		log.info("User log in successful, user = " + findByUsername);
