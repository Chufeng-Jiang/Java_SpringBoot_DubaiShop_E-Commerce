...
public class NewsController {
	...
	public String list(Model model,News news,PageBean<News> pageBean){
		model.addAttribute("title", "Press Releases List");
	...
	public Result<Boolean> add(News news){
		...
		operaterLogService.add("Add a press release: " + news);
	...
	public Result<Boolean> edit(News news){
		...
		operaterLogService.add("Edit a press release:" + findById);
		return Result.success(true);
	}
	...
	public Result<Boolean> delete(@RequestParam(name="id",required=true)Long id){
		...
		operaterLogService.add("Delete a press release, press release ID：" + id);
		return Result.success(true);
	}
}
