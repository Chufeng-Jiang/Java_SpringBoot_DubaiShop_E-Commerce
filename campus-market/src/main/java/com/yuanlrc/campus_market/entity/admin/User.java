...
public class User extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=4,maxLength=18,errorRequiredMsg="The user name cannot be empty.",errorMinLengthMsg="Length of user name should be longer than 4.",errorMaxLengthMsg="Length of user name should be no longer than 18.")
	@Column(name="username",nullable=false,length=18,unique=true)
	private String username;//用户名
	
	@ValidateEntity(required=true,requiredLeng=true,minLength=4,maxLength=32,errorRequiredMsg="The password cannot be empty.",errorMinLengthMsg="Length of password should be longer than 4.",errorMaxLengthMsg="Length of password should be no longer than 32.")
