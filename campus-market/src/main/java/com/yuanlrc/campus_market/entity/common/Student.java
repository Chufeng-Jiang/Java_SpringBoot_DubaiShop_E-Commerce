...
public class Student extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=6,maxLength=18,errorRequiredMsg="The student number cannot be empty.",errorMinLengthMsg="Length of student number should be longer than 6.",errorMaxLengthMsg="Length of student number should be no longer than 18.")
	@Column(name="sn",nullable=false,length=18,unique=true)
	private String sn;//学生学号
	
	@ValidateEntity(required=true,requiredLeng=true,minLength=6,maxLength=18,errorRequiredMsg="The password cannot be empty.",errorMinLengthMsg="Length of password should be longer than 6.",errorMaxLengthMsg="Length of password should be no longer than 18.")
	...
	@ValidateEntity(required=true,minLength=5,maxLength=12,errorMinLengthMsg="Length of qq should be longer than 5.",errorMaxLengthMsg="Length of qq should be no longer than 12.")
