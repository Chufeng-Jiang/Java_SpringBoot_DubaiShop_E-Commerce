...
public class Menu extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=1,maxLength=18,errorRequiredMsg="The menu name cannot be empty.",errorMinLengthMsg="Length of menu name should be longer than 1.",errorMaxLengthMsg="Length of menu name should be no longer than 18.")
