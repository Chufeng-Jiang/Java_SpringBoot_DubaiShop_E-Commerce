...
import com.yuanlrc.campus_market.entity.admin.dao.admin.DatabaseBakDao;
...
public class DatabaseBakService {
	...
	public void backup(){
		...
		try {
			...
			operaterLogService.add("Successful backup with file information: " + databaseBak);
		} catch (IOException e) {
	...
	public void restore(Long id){
		...
		if(databaseBak != null){
			try {
				...
				operaterLogService.add("Successful restore with file information: " + databaseBak);
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
