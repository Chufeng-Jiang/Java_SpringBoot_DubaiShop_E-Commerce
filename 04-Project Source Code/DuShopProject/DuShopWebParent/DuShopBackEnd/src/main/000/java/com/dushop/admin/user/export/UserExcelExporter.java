 ...
 *@CreateTime: 2022-07-22  11:49
 *@Description: TODO Apache POI
 *@Version: 1.0
 */
...
public class UserExcelExporter extends AbstractExporter {
    ...
    private void writeHeaderLine() {
        ...
        XSSFCellStyle cellStyle = exl_Workbook.createCellStyle();
        XSSFFont font = exl_Workbook.createFont();
        font.setBold(true);
     ...
     * @param: row
     * @param: columnIndex - attribute name of the column
     * @param: value - id, email, name, roles...
    ...
    public void export(List<User> listUsers, HttpServletResponse response) throws IOException {
        ...
        exl_Workbook.write(outputStream);
        exl_Workbook.close();
        outputStream.close();
