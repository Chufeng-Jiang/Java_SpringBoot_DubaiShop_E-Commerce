...
<title>${siteName!""}|Notice Board-${title!""}</title>
            ...
            <div class="card">
                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">Notice Board</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${newsTitle!""}" name="title" placeholder="Please input the title">
              ...
              <div class="card-body">
                ...
                <ul class="pagination ">
                  ...
                  <li><span>Total${pageBean.totalPage}Pages,${pageBean.total}data items</span></li>
                </ul>
                </#if>
              </div>
            </div>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('Press Release deleted successfully!',function(){
