          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                <li> <a href="/system/update_userinfo"><i class="mdi mdi-account"></i> Personal Information</a> </li>
                <li> <a href="/system/update_pwd"><i class="mdi mdi-lock-outline"></i> Edit Password</a> </li>
                <li class="divider"></li>
		    ...
		    <li class="dropdown dropdown-skin">
			  ...
			  <ul class="dropdown-menu dropdown-menu-right" data-stopPropagation="true">
                <li class="drop-title"><p>Themes</p></li>
				...
				<li class="drop-title"><p>Header</p></li>
				<li class="drop-skin-li clearfix">
                  <span class="inverse">
