              ...
              <div class="card-body">
                <form action="add" id="role-add-form" method="post" class="row">
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="Please input Role Name" tips="Please input Role Name" />
                  </div>
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('Role Addition Successful',function(){
