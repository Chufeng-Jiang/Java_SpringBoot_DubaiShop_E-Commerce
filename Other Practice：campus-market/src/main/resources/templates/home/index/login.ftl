...
<body>
<h1 style="color: #ffffff" opacity = 0 > 　　　　　　　　<sup> </sup></h1>
...
<div class="login" style="margin-top:60px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
				<div id="loginCue" class="cue">Welcome Login </div>
			
				<form action="login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" 
                    method="post">
                <div class="uinArea" id="uinArea">
                <label class="input-tips" for="id">Student No: </label>
               ...
               <div class="inputOuter" id="pArea">
                	...
                	<button id="login_button"type="button" value="Login" style="width:150px;" class="button_blue" href="javascript::">Login </button>
  ...
  <!--注册-->
    ...
    <div class="web_login">
        ...
        <ul class="reg_form" id="reg-ul">
        		<div id="userCue" class="cue">Please notice the format</div>

                <li>
                	
                    <label for="user"  class="input-tips2">Student No:</label>
                ...
                <li>
                <label for="passwd2" class="input-tips2">Re-Passeord: </label>
                    <div class="inputOuter2">
                ...
                <li>
                    <div class="inputArea">
                        <input type="button" id="reg_button"  style="margin-top:10px;margin-left:200px;" class="button_blue" value="Register"/>
                    </div>
...
<div class="jianyi">*Recommend to use IE browser 8 or above  or Chrome kernel browser to visit this site</div>
</body>
</html>