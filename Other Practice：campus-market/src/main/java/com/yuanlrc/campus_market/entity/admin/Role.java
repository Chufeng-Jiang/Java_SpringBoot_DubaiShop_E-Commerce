...
public class Role extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=1,maxLength=18,errorRequiredMsg="The role name cannot be empty.",errorMinLengthMsg="Length of role name should be longer than 1.",errorMaxLengthMsg="Length of menu name should be no longer than 18.")
