...
public class ReportGoods extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=1,maxLength=1000,errorRequiredMsg="The reason for reporting cannot be empty.",errorMinLengthMsg="Length of reporting should be longer than 4.",errorMaxLengthMsg="Length of reporting should be no longer than 1000.")
