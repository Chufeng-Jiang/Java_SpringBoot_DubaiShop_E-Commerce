...
public class GoodsCategory extends BaseEntity{
	...
	@ValidateEntity(required=true,requiredLeng=true,minLength=1,maxLength=18,errorRequiredMsg="The category name cannot be empty.",errorMinLengthMsg="Length of category name should be longer than 1.",errorMaxLengthMsg="Length of category name should be longer than 18.")
