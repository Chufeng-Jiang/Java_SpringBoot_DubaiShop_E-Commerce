...
<title>${siteName!""}|Menue - Edit</title>
              ...
              <div class="card-body">
                <form action="add" id="menu-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${menu.name}" placeholder="Please fill in the Menu Name" tips="Please fill in the Menu Name" />
                  </div>
                  <div class="input-group m-b-10">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" readonly="readonly" class="form-control required" id="icon" name="icon" value="${menu.icon}" placeholder="Please fill in the Menu icon" tips="Please fill in the Menu icon" />
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('Menue Edition Successful!',function(){
