  ...
  <#include "../common/top_header.ftl"/>
   <div class="container">
            <div class="main center">
                ...
                <div class="wantInfo-release-title">Post Wanted Goods</div>
                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        ...
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="required" id="tradePlace" name="tradePlace" value="" type="text" tips="Ecpected Trading Location"></div>
                            </div>
                        </div>
                        <div class="form-item l goods-price">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="sellPrice" name="sellPrice" value="" type="number" tips="Expected Price"></div>
                            </div>
                        </div>
                    </div>
